...
class TES3lint_Settings(
    wx.Dialog):  # Polemos: a new settings window for TES3lint (Maybe I should also create a standalone program out of this).
    ...
    def __init__(self, parent, pos):
        ...
        if True:  # Layout
            ...
            main_sizer.AddMany([(perl_sizer, 0, wx.EXPAND, 5), (tesl3int_sizer, 0, wx.EXPAND, 5),
                                (self.flags_radio_box, 0, wx.ALL | wx.EXPAND, 5),
                                (custom_flags_teslint_sizer, 0, wx.EXPAND, 5), (extras_teslint_sizer, 0, wx.EXPAND, 5),
                                (result_sizer, 0, wx.EXPAND, 5), (buttons_sizer, 0, wx.EXPAND, 5)])
    ...
    def import_settings(self):
        ...
        self.custom_flags_text.SetValue((','.join((str(x) for x in settings[1]))).strip('[ ]'))
