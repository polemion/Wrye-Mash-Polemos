...
import io, json, os, sys, wx
from . import dialog as gui
...
class WizardDialog(wx.Dialog):
    ...
    def __init__(self, title='Wrye Mash Polemos fork', pos=dPos,
        ...
        if True:  # Intro Panel
            ...
            self.welcome_Text = wx.StaticText(self.intro_panel, wx.ID_ANY, '', dPos, Size(-1, 60), CEN)
            self.introText1 = wx.StaticText(self.intro_panel, wx.ID_ANY, '', dPos, Size(-1, 55), CEN)
            self.line_1 = wx.StaticLine(self.intro_panel, wx.ID_ANY, dPos, dSize, wx.LI_HORIZONTAL)
            self.introText2 = wx.StaticText(self.intro_panel, wx.ID_ANY, '', dPos, Size(-1, 30), CEN)
            self.line_2 = wx.StaticLine(self.intro_panel, wx.ID_ANY, dPos, dSize, wx.LI_HORIZONTAL)
            self.introText3 = wx.StaticText(self.intro_panel, wx.ID_ANY, '', dPos, Size(-1, 65), CEN)
            self.introText4 = wx.StaticText(self.intro_panel, wx.ID_ANY,
            ...
            introPanSizer.AddMany([(self.welcome_Text, 0, EXP | wx.ALL, 5), (self.introText1, 0, EXP | wx.ALL, 5),
                                   ...
                                   (self.line_2, 0, EXP | BOT, 5), (self.introText3, 0, EXP | wx.ALL, 5),
                                   ((0, 0), 1, EXP, 5), (self.introText4, 0, EXP | wx.ALL, 5),
        ...
        if not conf.settings['openmw']:  # Regular Morrowind support: Main and Optional Paths Panel
            ...
            self.fldMw = wx.TextCtrl(mw_box, wx.ID_ANY, '', dPos, Size(-1, 21), wx.TE_READONLY, name='fldMw')
            self.btnBrowseMw = wx.Button(mw_box, wx.ID_OPEN, '...', dPos, Size(-1, 21), wx.BU_EXACTFIT,
                                         name='btnBrowseMw')
            ...
            self.fldInst = wx.TextCtrl(Instbox, wx.ID_ANY, '', dPos, Size(-1, 21), wx.TE_READONLY, name='fldInst')
            self.btnBrowseInst = wx.Button(Instbox, wx.ID_OPEN, '...', dPos, Size(-1, 21), wx.BU_EXACTFIT,
                                           name='btnBrowseInst')
            ...
            self.fldmlox = wx.TextCtrl(Mloxbox, wx.ID_ANY, '', dPos, Size(-1, 21), wx.TE_READONLY, name='fldmlox')
            self.btnBrowsemlox = wx.Button(Mloxbox, wx.ID_OPEN, '...', dPos, Size(-1, 21), wx.BU_EXACTFIT,
                                           name='btnBrowsemlox')
            ...
            self.MloxText2 = wx.StaticText(Mloxbox, wx.ID_ANY, _('If Mlox\'s folder '
                                           ...
                                           dPos, Size(-1, 30), 0)
            self.detect_Mlox_button = wx.Button(Mloxbox, wx.ID_ANY, 'Try to Detect Mlox Location', dPos, dSize, 0)
            # Sizers ========================================= #
            ...
            Mlox_Sizer.AddMany(
                [(Mods_BrwSizer, 0, EXP, 5), (self.MloxText1, 0, TOP | BOT, 5), (self.MloxText2, 0, TOP | BOT, 5),
                 (self.detect_Mlox_button, 0, EXP | TOP | BOT, 5)])
            mw_1_Sizer.AddMany(
                [(self.mw1_Text1, 0, EXP | LEF | RIG, 5), (mw_Sizer, 0, EXP | LEF | RIG, 5), ((0, 0), 1, 0, 5),
                 (InstSizer, 0, EXP | LEF | RIG, 5), ((0, 0), 1, 0, 5), (Mlox_Sizer, 0, EXP | LEF | RIG, 5),
                 ((0, 0), 1, 0, 5)])
        ...
        if conf.settings['openmw']:  # OpenMW/TES3mp support: Main Paths Panel
            ...
            self.fldOpenMWloc = wx.TextCtrl(openmw_te3mpbox, wx.ID_ANY, '', dPos, Size(-1, 21), wx.TE_READONLY,
                                            name='fldOpenMWloc')
            self.btnBrowseOpenMWloc = wx.Button(openmw_te3mpbox, wx.ID_OPEN, '...', dPos, Size(-1, 21), wx.BU_EXACTFIT,
                                                name='btnBrowseOpenMWloc')
            self.Openmw_te3mpText = wx.StaticText(openmw_te3mpbox, wx.ID_ANY, _('Select '
                                                                                'the location of OpenMW and/or TES3mp installation.'),
                                                  dPos, Size(-1, 30), 0)
            # Downloads directory
            ...
            self.fldDownloads = wx.TextCtrl(Downloadsbox, wx.ID_ANY, '', dPos, Size(-1, 21), wx.TE_READONLY,
                                            name='fldDownloads')
            self.btnBrowseDownloads = wx.Button(Downloadsbox, wx.ID_OPEN, '...', dPos, Size(-1, 21), wx.BU_EXACTFIT,
            ...
            self.flddatamods = wx.TextCtrl(Modsbox, wx.ID_ANY, '', dPos, Size(-1, 21), wx.TE_READONLY,
                                           name='flddatamods')
            self.btnBrowsedatamods = wx.Button(Modsbox, wx.ID_OPEN, '...', dPos, Size(-1, 21), wx.BU_EXACTFIT,
            ...
            openmw_1_Sizer.AddMany(
                [(self.openmw1_Text1, 0, EXP | wx.ALL, 5), (openmw_te3mpSizer, 0, EXP | wx.ALL, 5), ((0, 0), 1, 0, 5),
        ...
        if conf.settings['openmw']:  # OpenMW/TES3mp support: Openmw.cfg Error Panel
            ...
            self.fldOpenMWConf = wx.TextCtrl(Openmwcfgbox, wx.ID_ANY, '', dPos, Size(-1, 21), wx.TE_READONLY,
                                             name='fldOpenMWConf')
            self.btnBrowseOpenMWConf = wx.Button(Openmwcfgbox, wx.ID_OPEN, '...', dPos, Size(-1, 21), wx.BU_EXACTFIT,
            ...
            self.openmw2_Text4 = wx.StaticText(Openmwcfgbox, wx.ID_ANY, _('If you haven\'t run OpenMW before, '
                                                                          'you may try the following:'), dPos,
                                               Size(-1, 30), 0)
            self.openmw2_Text5 = wx.StaticText(Openmwcfgbox, wx.ID_ANY,
                                               _('1) Run OpenMW Launcher\n2) Configure it\n3) Click the button '
                                                 'below for Wrye Mash to retry locating openmw.cfg.'), dPos,
                                               Size(-1, 60), 0)
            ...
            OpenmwcfgSizer.AddMany([(Openmwcfg_BrwSizer, 1, EXP, 5), (self.openmw2_Text2, 0, TOP | BOT, 5),
                                    (self.openmw2_Text3, 0, TOP | BOT, 5),
                                    (self.openmw2_Text4, 0, TOP | BOT, 5), (self.openmw2_Text5, 0, TOP | BOT, 5),
                                    ((0, 0), 1, EXP, 5), (self.detect_openmwcfg_button, 0, EXP, 5)])
        ...
        if conf.settings['openmw']:  # OpenMW/TES3mp support: Optional Settings Panel
            ...
            self.fldDataFiles = wx.TextCtrl(OpenDataFilesbox, wx.ID_ANY, '', dPos, Size(-1, 21), wx.TE_READONLY,
                                            name='fldDataFiles')
            self.btnBrowseDataFiles = wx.Button(OpenDataFilesbox, wx.ID_OPEN, '...', dPos, Size(-1, 21),
            ...
            self.fldTES3mpConf = wx.TextCtrl(Tes3mpbox, wx.ID_ANY, '', dPos, Size(-1, 21), wx.TE_READONLY,
                                             name='fldTES3mpConf')
            self.btnBrowseTES3mpConf = wx.Button(Tes3mpbox, wx.ID_OPEN, '...', dPos, Size(-1, 21), wx.BU_EXACTFIT,
            ...
            self.fldmlox64 = wx.TextCtrl(Mlox64box, wx.ID_ANY, '', dPos, Size(-1, 21), wx.TE_READONLY,
                                         name='fldmlox64')
            self.btnBrowsemlox64 = wx.Button(Mlox64box, wx.ID_OPEN, '...', dPos, Size(-1, 21), wx.BU_EXACTFIT,
            ...
            OpenDataFilesSizer.AddMany(
                [(OpenDataFiles_BrwSizer, 0, EXP, 5), (self.OpenDataFilesSizerText, 0, wx.ALL, 5)])
            ...
            Mlox64_Sizer.AddMany(
                [(Mlox64_BrwSizer, 0, EXP, 5), (self.Mlox64Text, 0, wx.ALL, 5), (self.detect_Mlox64_button, 0, EXP, 5)])
            openmw_3_Sizer.AddMany(
                [(self.openmw3_Text, 0, EXP, 5), (OpenDataFilesSizer, 0, EXP | RIG | LEF, 5), ((0, 0), 1, EXP, 5),
        ...
        if True:  # Last Panel
            ...
            self.UpdateText1 = wx.StaticText(Updatebox, wx.ID_ANY, _('Would you like to be notified when '
                                                                     'the next Wrye Mash version is released?'), dPos,
                                             Size(-1, 30), 0)
            ...
            self.UpdateSpnText = wx.StaticText(Updatebox, wx.ID_ANY, _('Frequency in Days (0=Everyday):'), dPos, dSize,
                                               0)
            self.Update_spinCtrl = wx.SpinCtrl(Updatebox, wx.ID_ANY, '', dPos, Size(45, -1),
            ...
            UpdateSizer.AddMany([(self.UpdateText1, 0, wx.ALL, 5), (self.Update_checkBox, 0, BOT, 5),
            ...
            EndSizer.AddMany([(self.EndText1, 0, EXP, 5), (UpdateSizer, 0, EXP | wx.ALL, 5), ((0, 0), 1, 0, 5),
                              (EncodingSizer, 0, EXP | wx.ALL, 5), ((0, 0), 1, 0, 5),
                              (InterfaceSizer, 0, EXP | wx.ALL, 5), ((0, 0), 1, EXP, 5),
        ...
        if True:  # Footer
            ...
            self.back_button = wx.Button(self, wx.ID_BACKWARD, '<Back', dPos, Size(75, -1), 0)
            self.next_Fin_button = wx.Button(self, wx.ID_FORWARD, 'Next>', dPos, Size(75, -1), 0)
            self.cancel_Quit__button = wx.Button(self, wx.ID_CANCEL, 'Quit', dPos, Size(75, -1), 0)
            # Sizers ========================================= #
            footerSizer = wx.BoxSizer(wx.HORIZONTAL)
            footerSizer.AddMany(
                [(self.back_button, 0, wx.ALL, 5), (self.next_Fin_button, 0, wx.ALL, 5), ((0, 0), 1, EXP, 5),
        ...
        if True:  # Sizers
            ...
            if conf.settings['openmw']:  # OpenMW/TES3mp support
                panelsSizer.AddMany([(self.openmw_1_panel, 1, EXP | TOP, 5), (self.openmw_2_panel, 1, EXP, 5),
            ...
            mainSizer.AddMany(
                [(contentsSizer, 1, EXP, 5), (self.mainLine, 0, EXP | RIG | LEF, 5), (footerSizer, 0, EXP, 5)])
    ...
    def onUpdate(self, event):
        ...
        if not conf.settings['openmw']:  # Regular Morrowind Rules
            ...
            elif all([not self.check_empty(), 1 in self.disabled, self.check_conflicts()]):
        ...
        # Common
        [x.Disable() if not self.Update_checkBox.IsChecked() else x.Enable() for x in
         (self.UpdateSpnText, self.Update_spinCtrl)]
        # Refresh Panel
        if self.allows:
            self.RefPan()
            self.allows = False
    ...
    def check_conflicts(self, mode='check'):
        ...
        [x.SetForegroundColour(wx.RED) if x.GetValue().rstrip('\\ ').lower() in conflicts else x.SetForegroundColour(
            wx.BLACK) for x in self.wizard_fields]
        self.RefPan()
    ...
    def check_folders(self, folder, showmsg=False):
        ...
        if folder == 'fldOpenMWConf':  # OpenMW Path Check
            try:
                ...
                if os.path.isfile(os.path.join(os.path.dirname(self.fldOpenMWConf.GetValue()).rstrip('\\'),
    ...
    def OnBack(self, event):
        ...
        if self.next_Fin_button.GetLabel() != 'Next>': self.next_Fin_button.SetLabel('Next>')
        NextPanel.Hide()
        CurPanel.Show()
        self.Layout()
    ...
    def OnNextFin(self, event):
        ...
        if self.PanelID < maxPanel:
            ...
            if self.cancel_Quit__button.GetLabel() != 'Cancel': self.cancel_Quit__button.SetLabel('Cancel')
            PrevPanel.Hide()
            CurPanel.Show()
            self.Layout()
        else:
    ...
    def SaveSettings(self):
        ...
        [x for num, x in enumerate(self.themeData) if num == self.Interface_choices.GetSelection()][0]
        conf.settings['profile.encoding'] = [enc for enc in profileEncodings if enc in
                                             [x for num, x in enumerate(self.Encoding_Ch) if
                                              num == self.Encoding_choices.GetSelection()][0]][0]
    ...
    def InitSettings(self):
        ...
        self.Interface_choices.SetSelection(
            [num for num, x in enumerate(self.themeData) if x[0] == conf.settings['active.theme'][0]][0])
        try:
            self.Encoding_choices.SetSelection(
                [num for num, x in enumerate(self.Encoding_Ch) if conf.settings['profile.encoding'] in x][0])
        except:
            self.Encoding_choices.SetSelection(
                [num for num, x in enumerate(self.Encoding_Ch) if defaultEncoding in x][0])
        ...
        if conf.settings['openmw']:  # OpenMW/Tes3MP
            ...
            try:
                ...
                pass
            try:
                self.fldOpenMWConf.SetValue(os.path.join(conf.settings['openmwprofile'], 'openmw.cfg'))
            except:
                pass
            try:
    ...
    def txtwraps(self):
        ...
        # Common
        [x.Wrap(-1) for x in
         (self.welcome_Text, self.introText1, self.introText2, self.introText3, self.introText4, self.introText5,
        ...
        if conf.settings['openmw']:  # OpenMW/TES3mp support
            [x.Wrap(-1) for x in
             (self.openmw1_Text1, self.Openmw_te3mpText, self.DownloadsText, self.ModsText, self.openmw2_Text1,
    ...
    def setFonts(self):
        ...
        RegBoldFont = wx.Font(wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
                              wx.FONTWEIGHT_BOLD, False, '')
        RegFont = wx.Font(wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL,
